...
events_by_day = {
    ...
    "Wednesday": [
        ...
        {"name": "Drew & Ellie Holcomb at Tulsa Theater", "time": "8:00 PM", "venue": "Tulsa Theater, 105 W Reconciliation Way", "description": "Singer-songwriter duo Drew and Ellie Holcomb live at one of Tulsa's most beloved performance venues. Folk-Americana warmth in a gorgeous room. Tickets recommended in advance.", "url": "https://tulsatheater.com"},
        {"name": "Evan Honer: It's A Long Road Tour", "time": "Doors 6:30 PM", "venue": "Cain's Ballroom, 423 N Main St", "description": "Evan Honer brings the It's A Long Road Tour to the most storied ballroom in Oklahoma, with Timmy Skelly. All ages. Cain's on a Wednesday with a good touring artist is a reliable good night.", "url": "https://www.cainsballroom.com"},
    ...
    "Thursday": [
        ...
        {"name": "Molly Tuttle at Cain's Ballroom", "time": "Doors 6:30 PM", "venue": "Cain's Ballroom, 423 N Main St", "description": "Grammy-winning singer-songwriter and flat-picking guitar prodigy Molly Tuttle live at Cain's. Bluegrass with soul and serious chops. Start the night here, then walk down to Club Majestic after.", "url": "https://www.cainsballroom.com"},
